                ...
                <div className="data-table-container">
                    ...
                    {paginatedData.map((item, index) => (
                        <div className='theme-card' key={index}>
                                ...
                                <div className='td'>
                                    <div className='large-qty'>
                                        <div className='item'>
                                            ...
                                            <p>Exchange Initiated by: Customer</p>
                                        ...
                                        <div className='item'>
                                            ...
                                            <p>I ordered s 24 ultra and received s23 ultra!</p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <button type='button' className='orange_border_btn'>View all</button>
                            </div> */}
                            <div className='rows'>
                                <div className='order-sb-details reasons'>
                                    <div className='item'>
                                        <div className='subtext'>
                                            Cancel by: <br /> System default cancel
                                        </div>
                                    </div>
                                    <div className='item'>
                                        Cancel Comment:<br/>
                                        Didn’t complete the application within 7 days.,
                                    </div>
                                </div>
                            </div>
                            <div className='rows footer-info'>
                                ...
                                <div>
                                    <div className='action-btns'>
                                        ...
                                        <Link to='/orders/exchange/form' className='orange_button'>Action</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
