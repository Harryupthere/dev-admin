    ...
    return (
        <div className='campaigns-data-wrapped'>
            <div className='action-card'>
                <Link to='/campaigns/create-campaigns' className='orange_button ms-auto' >Create New Campaign</Link>
            </div>
                ...
                {paginatedData?.map((tabledata, index) => (
                    <div className='product-item' key={index}>
                        <div className='item-body'>
                            <div className='body-item image-item'>
                                <div className='given-img'>
                                    <img src={images['campaign-banner.png']} alt='img' />
                                </div>
                            </div>
                        ...
                        <div className='item-footer'>
                            ...
                            <div className='rightside'>
                                ...
                                <Link className='orange_button' to='/campaigns/campaign-onboarding'>Add Prodcuts</Link>
                            </div>
                        </div>
                    </div>
                ))}
