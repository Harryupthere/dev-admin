...
const AcceptClaimModal = ({ openModal, closeModal }) => {

    return (
        <Modal show={openModal} className='fairbay_modals' centered>
            <div className='modal_header'>
                <div className='main_heading'><h2>Confirm acceptance of the claim</h2></div>
                <button type='button' onClick={closeModal} className='cancel-btn'><CrossIcon /></button>
            </div>
            <div className='modal_body py_10px'>
                <span style={{color:'var(--color_647C9B)'}}>Claim is irreversible once accepted.</span>
            </div>
