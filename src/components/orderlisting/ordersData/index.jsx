                            ...
                            <div className='rows footer-info'>
                                ...
                                <div>
                                    <div className='action-btns'>
                                        ...
                                        <button type='button' className='orange_border_btn' onClick={handleOpenCancelRequest}>Cancel Order</button>
                                        <button type='button' className='orange_button'>Print AWB</button>
                                        <button type='button' className='blue_button'>Ready to Ship</button>
                                    </div>
                                </div>
                            </div>
                        </div>
