    ...
    <>
      <div className="terms-conditions-data page-data-layout">
        ...
        <div className="text-top">
          <p>
            This privacy notice for FAIRBAY (PVT) LTD (
          ...
          <ul>
            <li>
              Download and use our mobile application (FairBay), or any other
                ...
                <Accordion.Body>
                  <div className="text-top">
                    ...
                    <p className="mb-3">
                      ...
                      <NavLink to="http://www.fairbay.lk/privacy.">
                        http://www.fairbay.lk/privacy.{" "}
                      </NavLink>
                    </p>
              ...
              <Accordion.Item eventKey="1">
                ...
                <div className="text-top">
                 <p className="mb-3">
                    ...
                    <li> <p >
                      <BoldText> To deliver targeted advertising to you.</BoldText> We may process your information to develop and display personalized content and advertising tailored to your interests, location, and more. For more information see our Cookie Notice: <NavLink to=""> http://www.fairbay.lk/privacy.
                      </NavLink>
                    </p> </li>
              ...
              <Accordion.Item eventKey="3">
                ...
                <div className="text-top">
                   <p className="mb-3">
                    ...
                    <p>We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our Cookie Notice: <NavLink to="http://www.fairbay.lk/privacy."> http://www.fairbay.lk/privacy.</NavLink></p>
                  </div>
                </Accordion.Body>
              </Accordion.Item>
